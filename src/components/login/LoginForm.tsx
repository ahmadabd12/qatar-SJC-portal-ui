      ...
      <div className="w-full max-w-md">
        ...
        <div className="space-y-6">
          {!showDemoLogin ? (
            <>
              ...
              <Button
                ...
                className="w-full bg-maroon-800 hover:bg-maroon-800/90 text-white py-4 text-base font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl"
                size="lg"
              >
                <div className="flex items-center justify-center">
                  <svg
                    className="mr-3 h-5 w-5 rtl:ml-3 rtl:mr-0"
                    viewBox="0 0 23 23"
                    fill="currentColor"
                  >
              ...
              <Button
                ...
                variant="outline"
                className="w-full border-2 border-maroon-800 text-maroon-800 hover:bg-gray-50 py-4 text-base font-normal rounded-lg transition-all duration-200"
                size="lg"
              >
                <Building className="mr-2 h-5 w-5 rtl:ml-2 rtl:mr-0 font-normal" />
                {t("auth.demoLogin")}
              </Button>
            </>
          ) : (
          ...
          <div className="pt-6 border-t border-gray-200">
            ...
            >
              <Globe className="h-5 w-5 text-maroon-800" />
